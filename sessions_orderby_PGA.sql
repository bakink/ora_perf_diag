...
COLUMN os_pid FORMAT 9999999999 HEADING 'O/S PID' JUSTIFY right
COLUMN session_program FORMAT a24 HEADING 'Session Program' TRUNC
...
column oracle_username session_status clear
column os_username clear
column os_pid clear
column session_program clear
column session_machine clear
column session_pga_memory clear
column session_pga_memory_max clear
column session_uga_memory clear
column session_uga_memory_max clear
