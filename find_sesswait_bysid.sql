--------------------------------------------------------------------------------
--
-- File name:   find_sesswait_bysid.sql
-- Purpose:     Display current Session Wait info based on username
--              
...
PROMPT
accept _sid PROMPT "&_C_RED Enter SID: &_C_RESET" 
...
select 
        sw.sid sw_sid,substr(username,1,20) username, 
		...
		s.serial#,
        sw.seq#, 
        sw.seconds_in_wait sec_in_state, '&_C_RED'||s.sql_id||'&_C_RESET' sqlid,s.sql_child_number chn,
...
col sw_event clear;
col sw_p1transl clear;
col sw_sid  clear;
col sw_p1 clear;
col sw_p2 clear;
col sw_p3 clear;
col chn clear;
col blckng_sid clear;
col blckng_inst clear;
col blckng_sid_status clear;
col username clear;
